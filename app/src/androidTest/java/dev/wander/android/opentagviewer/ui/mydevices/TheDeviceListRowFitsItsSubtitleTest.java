...
public class TheDeviceListRowFitsItsSubtitleTest {
     ...
     *
     * <p>A clipped view still reports its text and still passes a {@code withText} check, so this
     * asks for its height instead: a {@code TextView} squeezed to nothing is the shape of the
     * failure.
     */
    @Test
